            ...
            <div className="flex items-center w-full pr-14">
              ...
              <div className="w-full px-4 flex items-center min-h-[55px]">
                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                  ...
                  <h1 className="text-lg font-bold text-yellow-400">{companyName}</h1>
                </div>
            ...
            <div className="w-full px-4 flex items-center min-h-[75px]">
              ...
              <div className="flex items-center gap-3 flex-shrink-0">
                ...
                <div className="flex flex-col">
                  <h1 className="text-lg font-bold text-yellow-400 leading-tight">{companyName}</h1>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h5 className="font-bold text-lg text-yellow-400">{companyName}</h5>
              </div>
